...
namespace aux
{
    ...
    private:
        constexpr static auto at(std::initializer_list<T> args, size_t i) noexcept {
...
{
    template <class T, size_t N>
    struct tuple_size<aux::versor<T, N>> { static constexpr auto value = N; };
    template <size_t I, class T, size_t N>
    struct tuple_element<I, aux::versor<T, N>> { using type = T; };
